...
✍️ Documentación clara y estructurada de requerimientos, planes de prueba y resultados.
🧪 Diseño y ejecución de casos de prueba funcionales y exploratorios.
🐞 Reporte de bugs con criterios de severidad y prioridad en JIRA.
🧠 Validación de calidad desde la perspectiva del usuario final y del lenguaje.
🔄 Pruebas de APIs REST usando Postman.
🗂️ Coordinación de pequeños procesos, seguimiento y control de calidad.
